 ...
 * DESCRIPTION:
 *
 *    This file contains common definitions of data alignment, DRAM section,  SIMD width
 *    PPM Image structures, time stamp, user defined hooks etc...
 *
 * ****************************************************************************/
